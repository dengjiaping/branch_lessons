...
//        Log.e("state", "====+onDetachedFromWindow");
...
//        Log.e("state", "====+setLastUpdateTimeKey");
...
//        Log.e("state", "====+setLastUpdateTimeRelateObject");
        setLastUpdateTimeKey(object.getClass().getName());
    }

    private void buildAnimation() {
//        Log.e("state", "====+buildAnimation");
...
//        Log.e("state", "====+resetView");
        hideRotateView();
        mProgressBar.setVisibility(INVISIBLE);
    }

    private void hideRotateView() {
//        Log.e("state", "====+hideRotateView");
