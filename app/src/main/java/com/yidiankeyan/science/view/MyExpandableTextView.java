...
//    protected ImageButton mButton; // Button to expand/collapse
    ...
    /**
     * 判断文字行数是否大于3，如果是的话就显示“显示全文”，不是则隐藏
     */
    public void judgmentTvExpandShow() {
...
//        mButton.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);
        ...
        if (mCollapsed) {
            ...
            EventMsg msg = EventMsg.obtain(SystemConstant.COMMENT_EXPAND);
            msg.setArg1(mTextHeightWithMaxLines - mTv.getHeight());
