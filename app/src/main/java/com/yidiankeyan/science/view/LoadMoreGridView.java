 ...
 * 作用：
 */
public class LoadMoreGridView extends GridViewWithHeaderAndFooter implements OnScrollBottomListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, cn.finalteam.loadingviewfinal.loadingview.R.styleable.LoadingViewFinal);

        if (a.hasValue(cn.finalteam.loadingviewfinal.loadingview.R.styleable.LoadingViewFinal_loadMoreMode)) {
            mLoadMoreMode = LoadMoreMode.mapIntToValue(a.getInt(cn.finalteam.loadingviewfinal.loadingview.R.styleable.LoadingViewFinal_loadMoreMode, 0x01));
        } else {
            mLoadMoreMode = LoadMoreMode.SCROLL;
        }

        if (a.hasValue(cn.finalteam.loadingviewfinal.loadingview.R.styleable.LoadingViewFinal_noLoadMoreHideView)) {
            mNoLoadMoreHideView = a.getBoolean(cn.finalteam.loadingviewfinal.loadingview.R.styleable.LoadingViewFinal_noLoadMoreHideView, false);
        } else {
            mNoLoadMoreHideView = false;
        }

        if (a.hasValue(cn.finalteam.loadingviewfinal.loadingview.R.styleable.LoadingViewFinal_loadMoreView)) {
            try {
                String loadMoreViewName = a.getString(cn.finalteam.loadingviewfinal.loadingview.R.styleable.LoadingViewFinal_loadMoreView);
...
//        }
    ...
    public void setHasLoadMore(boolean hasLoadMore) {
        ...
        if (!mHasLoadMore) {
            ...
            mLoadMoreView.getFooterView().setOnClickListener(null);
        } else {
