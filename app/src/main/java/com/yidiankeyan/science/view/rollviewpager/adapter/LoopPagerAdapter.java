package com.yidiankeyan.science.view.rollviewpager.adapter;
...
import com.yidiankeyan.science.view.rollviewpager.HintView;
...
public abstract class LoopPagerAdapter extends PagerAdapter {
    ...
    private OnCustomPageSelect onCustomPageSelect;
    ...
    public void setOnCustomPageSelect(OnCustomPageSelect onCustomPageSelect) {
        this.onCustomPageSelect = onCustomPageSelect;
    }
    ...
    private View findViewByPosition(ViewGroup container, int position) {
        for (View view : mViewList) {
            if (((int) view.getTag(R.id.image_position)) == position && view.getParent() == null) {
                if (onCustomPageSelect!=null){
                    onCustomPageSelect.onPageSelect(container, position);
                }
                return view;
            }
        }
        View view = getView(container, position);
        view.setTag(R.id.image_position, position);
        mViewList.add(view);
        return view;
    }
    ...
    public interface OnCustomPageSelect {
        void onPageSelect(ViewGroup container, int position);
    }
}
