...
public class MarqueeView extends ViewFlipper {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lineSpacingExtra = typedArray.getDimensionPixelSize(R.styleable.MarqueeViewStyle_mvLineSpacingExtra, 10);
        lines = typedArray.getInt(R.styleable.MarqueeViewStyle_mvLines, 0);
        animDuration = typedArray.getInteger(R.styleable.MarqueeViewStyle_mvAnimDuration, animDuration);
        if (typedArray.hasValue(R.styleable.MarqueeViewStyle_mvTextSize)) {
            textSize = typedArray.getDimensionPixelSize(R.styleable.MarqueeViewStyle_mvTextSize, textSize);
    ...
    private TextView createTextView(CharSequence text, int position) {
        ...
        tv.setText(text);
        tv.setLineSpacing(lineSpacingExtra, 1);
