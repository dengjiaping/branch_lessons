 ...
 * -已订专辑
 */
public class BookedAlbumFragment extends Fragment {


    private PtrClassicFrameLayout ptrLayout;
    private BookedAlbumAdapter adapter;
    private ListViewFinal lvBooked;
    private View rlBooked;
    private IntentFilter intentFilter;
    //页面数据
    private List<BusinessAllBean> mDatas = new ArrayList<>();

    public BookedAlbumFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_booked_album, container, false);
     ...
     * 获取大牛已订专辑
     */
    private void toHttpGetWhizOrder() {
    ...
    private void initView(View view) {
        ...
        lvBooked = (ListViewFinal) view.findViewById(R.id.lv_booked);
        rlBooked = getActivity().findViewById(R.id.rl_booked);
    }
