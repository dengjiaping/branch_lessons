...
import com.yidiankeyan.science.information.fragment.ClsVideoAllFragment;
import com.yidiankeyan.science.information.fragment.ClsVideoBookedFragment;
...
public class ClassVideoActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        tvAllAlbum = (TextView) findViewById(R.id.txt_clsall);
        tvSubscribedAlbum = (TextView) findViewById(R.id.txt_clsbooked);
        viewPager = (ViewPager) findViewById(R.id.view_pager);
        txtTitle.setText("视频专辑");
    }
    ...
    protected void initAction() {
        ...
        fragments.add(new ClsVideoAllFragment());
        fragments.add(new ClsVideoBookedFragment());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ll_return:
                finish();
                break;
            case R.id.txt_clsall:
                currIndex = 0;
                viewPager.setCurrentItem(currIndex);
                break;
            case R.id.txt_clsbooked:
                currIndex = 1;
                viewPager.setCurrentItem(currIndex);
                break;
        }
