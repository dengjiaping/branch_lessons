 ...
 * -已订专辑
 */
public class NumberBookedFragment extends Fragment {

    private PtrClassicFrameLayout ptrLayout;
    private BookedAlbumAdapter adapter;
    private ListViewFinal lvNb;
    private IntentFilter intentFilter;
    //页面数据
    private List<BusinessAllBean> mDatas = new ArrayList<>();
    private View llBus;

    public NumberBookedFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_number_booked, container, false);
        ...
        adapter.setLlBooked(llBus);
        lvNb.setAdapter(adapter);
     ...
     * 获取企业号已订专辑
     */
    private void toHttpGetBusinessOrder() {
...
//                String orderId = (String);
    ...
    private void initView(View view) {
        ...
        lvNb = (ListViewFinal) view.findViewById(R.id.lv_numberbooked);
        llBus =  getActivity().findViewById(R.id.ll_bus);
    }
}
