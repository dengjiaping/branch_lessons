 ...
 * -墨子音频播放
 */
public class MozReadAudioActivity extends BaseActivity {
    ...
    protected int setContentView() {
        ...
        return R.layout.activity_moz_read_audio;
    }
...
//            if (AudioPlayManager.getInstance().mediaPlayer != null) {
//                AudioPlayManager.getInstance().mediaPlayer.seekTo(seekBar.getProgress());
...
//            }
    ...
    protected void initView() {
        ...
        llMozReadAudio = (AutoLinearLayout) findViewById(R.id.activity_moz_read_audio);
    ...
    protected void initAction() {
        ...
        ApiServerManager.getInstance().getApiServer().getMozBookDetail(map).enqueue(new RetrofitCallBack<MozReadDetailsBean>() {
            @Override
            public void onSuccess(Call<RetrofitResult<MozReadDetailsBean>> call, Response<RetrofitResult<MozReadDetailsBean>> response) {
            ...
            @Override
            public void onFailure(Call<RetrofitResult<MozReadDetailsBean>> call, Throwable t) {
...
//        }
    ...
    public void onEvent(EventMsg msg) {
        if (!(DemoApplication.getInstance().currentActivity() instanceof MozReadAudioActivity))
            return;
        switch (msg.getWhat()) {
...
//                break;
    ...
    private void toHttpReadNumber() {
        Map<String, Object> map = new HashMap<>();
        map.put("id", getIntent().getStringExtra("id"));
        HttpUtil.post(this, SystemConstant.URL + SystemConstant.INSERT_READ_NUMBER, map, new HttpUtil.HttpCallBack() {
            @Override
