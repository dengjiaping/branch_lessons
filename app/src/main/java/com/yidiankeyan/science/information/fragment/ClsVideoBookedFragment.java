...
import com.yidiankeyan.science.information.adapter.ClassVideosAdapter;
 ...
 * -已订专辑
 */
public class ClsVideoBookedFragment extends Fragment {

    private PtrClassicFrameLayout ptrLayout;
    private ClassVideosAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new ClassVideosAdapter(getActivity(), mDatas);
...
//                String orderIds = (String) ;
    ...
    private void initView(View view) {
        ...
        llClassTxt = (AutoLinearLayout) getActivity().findViewById(R.id.ll_class_video);
    }
}
