 ...
 * -已订专辑
 */
public class BookedAlbumForScienceNovelFragment extends Fragment {

    private PtrClassicFrameLayout ptrLayout;
    private BookedAlbumAdapter adapter;
    private ListViewFinal lvNovel;
    private IntentFilter intentFilter;
    //页面数据
    private List<BusinessAllBean> mDatas = new ArrayList<>();
    private View llNove;

    public BookedAlbumForScienceNovelFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_scnovel, container, false);
    ...
    private void initView(View view) {
        ...
        lvNovel = (ListViewFinal) view.findViewById(R.id.lv_scnovel);
        llNove = getActivity().findViewById(R.id.ll_nove);
    }
