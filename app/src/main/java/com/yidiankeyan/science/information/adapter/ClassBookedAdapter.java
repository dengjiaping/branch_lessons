 ...
 * -已订专辑Adapter
 */
public class ClassBookedAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public ClassBookedAdapter(Context context, List<BookedAlbumBean> mDatas) {
...
//                    mPopupWindow.setOutsideTouchable(true);
//                    mPopupWindow.setBackgroundDrawable(new BitmapDrawable());
//                    mPopupWindow.showAtLocation(((Activity) context).findViewById(R.id.ll_class_txt), Gravity.BOTTOM, 0, 0);
//                    mPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
//                        @Override
//                        public void onDismiss() {
//                            Util.finishPop((Activity) context, mPopupWindow);
...
//                    mDatas.remove(viewHolder.position);
//                    notifyDataSetChanged();
//                    ((ClassImaTxtActivity) context).loadingDismiss();
//                }
//            }
//
//            @Override
