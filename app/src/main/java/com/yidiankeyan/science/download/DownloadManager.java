...
public final class DownloadManager {
    ...
    public synchronized DownloadInfo startDownload(String url, String label, String savePath,
                                                   boolean autoResume, boolean autoRename,
                                                   DownloadViewHolder viewHolder, int contentNum, String contentId) throws DbException {
        ...
        if (downloadInfo == null) {
            ...
            downloadInfo.setContentId(contentId);
            downloadInfo.setContentNum(contentNum);
    ...
    public synchronized void startDownload(String url, String label, String savePath,
                                           boolean autoResume, boolean autoRename,
                                           DownloadViewHolder viewHolder, String contentId, int fileType, int contentNum) throws DbException {
    ...
    public void removeAllDownload() throws DbException {
        for (Iterator<DownloadInfo> it = downloadInfoList.iterator(); it.hasNext(); ) {
