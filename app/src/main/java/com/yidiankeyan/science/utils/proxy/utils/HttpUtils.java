package com.yidiankeyan.science.utils.proxy.utils;

import android.util.Log;

import com.yidiankeyan.science.utils.proxy.Constants;
...
import static com.yidiankeyan.science.utils.proxy.Constants.DOWNLOAD_PATH;
...
public class HttpUtils {
    ...
    public static HttpResponse send(HttpUriRequest request) {
        ...
        if (line.getStatusCode() != 200 && line.getStatusCode() != 206) {
            ProxyUtils.delete(new File(DOWNLOAD_PATH));
