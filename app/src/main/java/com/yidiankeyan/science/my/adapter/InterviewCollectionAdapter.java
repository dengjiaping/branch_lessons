...
public class InterviewCollectionAdapter extends BaseAdapter {

    private Context mContext;
    private List<InterviewSoonBean> mData;
    private LayoutInflater mInflater;

    public InterviewCollectionAdapter(Context context, List<InterviewSoonBean> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tvAuthorName.setText(mData.get(position).getCreateTime().replace(".0", ""));
        holder.tvTitle.setText(mData.get(position).getInterviewName());
        Glide.with(mContext).load(Util.getImgUrl(mData.get(position).getInterviewImgUrl()))
