package fm.jiecao.jcvideoplayer_lib.proxy.utils;
...
import fm.jiecao.jcvideoplayer_lib.proxy.Constants;

import static fm.jiecao.jcvideoplayer_lib.proxy.Constants.DOWNLOAD_PATH;
