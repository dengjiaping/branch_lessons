 ...
 * Date:16/3/7 上午11:34
 */
public class HaveMoreListViewFinal extends ListView implements OnScrollBottomListener{
    ...
    public HaveMoreListViewFinal(Context context) {
        super(context);
        init(context, null);
    }

    public HaveMoreListViewFinal(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public HaveMoreListViewFinal(Context context, AttributeSet attrs, int defStyleAttr) {
