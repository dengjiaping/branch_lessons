 ...
 * Date:16/3/7 上午11:34
 */
public class ListViewFinalLoadMore extends ListView implements OnScrollBottomListener {
    ...
    public ListViewFinalLoadMore(Context context) {
        super(context);
        init(context, null);
    }

    public ListViewFinalLoadMore(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ListViewFinalLoadMore(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private class ListViewOnScrollListener implements OnScrollListener {
        ...
        public void onScrollStateChanged(AbsListView listView, int scrollState) {
            ...
            if (myOnScrollListener != null)
                myOnScrollListener.onScrollStateChanged(listView, scrollState);
        }
